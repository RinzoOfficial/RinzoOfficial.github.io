...
document.querySelectorAll('.feature-card, .tool-card, .function-card, .screenshot-item, .faq-item').forEach(el => {
    el.style.opacity = '0';
...
const cards = document.querySelectorAll('.feature-card, .tool-card, .function-card, .sidebar-card, .faq-item');
...
cards.forEach(card => {
    card.addEventListener('mouseenter', (e) => {
        ...
        glow.style.background = 'radial-gradient(circle, rgba(99, 102, 241, 0.3), transparent)';
